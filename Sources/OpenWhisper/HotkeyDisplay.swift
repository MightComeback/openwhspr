...
enum HotkeyDisplay {
    ...
    static func canonicalKey(_ raw: String) -> String {
        ...
        case "eject", "ejectkey", "⏏": return "eject"
        case "caps", "capskey": return "capslock"
        case "function", "fnkey", "globe", "globekey", "fn/globe", "globe/fn", "🌐": return "fn"
        case "section", "sectionkey", "paragraph", "§", "±": return "section"
        case "←", "leftarrow", "arrowleft", "leftkey": return "left"
        case "→", "rightarrow", "arrowright", "rightkey": return "right"
        case "↑", "uparrow", "arrowup", "upkey": return "up"
        case "↓", "downarrow", "arrowdown", "downkey": return "down"
        ...
        case "grave", "graveaccent", "gravekey", "backquote", "backquotekey", "backtickkey", "quoteleft", "tilde", "~": return "backtick"
        ...
        case "numpadenter", "numenter", "numenterkey", "kpenter", "keypadenterkey", "numreturn", "numpadreturn", "kpreturn", "keypadreturn": return "keypadenter"
