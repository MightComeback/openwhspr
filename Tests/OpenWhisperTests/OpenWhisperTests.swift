...
final class OpenWhisperTests: XCTestCase {
    ...
    func testHotkeyCanonicalAliases() throws {
        ...
        XCTAssertEqual(HotkeyDisplay.canonicalKey("⇞"), "pageup")
        XCTAssertEqual(HotkeyDisplay.canonicalKey("⇟"), "pagedown")
        ...
        XCTAssertEqual(HotkeyDisplay.canonicalKey("⌧"), "keypadclear")
