...
final class HotkeyMonitorTests: XCTestCase {
    ...
    func testDeleteAliasAlsoMatchesForwardDeleteKeyCode() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
    ...
    func testForwardDeleteAliasAlsoMatchesDeleteKeyCode() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenShift)
        defaults.set("forwarddelete", forKey: AppDefaults.Keys.hotkeyKey)
        defaults.set(HotkeyMode.toggle.rawValue, forKey: AppDefaults.Keys.hotkeyMode)
    ...
    func testEjectAliasMatchesEjectKeyCode() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenShift)
        defaults.set("eject", forKey: AppDefaults.Keys.hotkeyKey)
        defaults.set(HotkeyMode.toggle.rawValue, forKey: AppDefaults.Keys.hotkeyMode)

        let monitor = HotkeyMonitor(defaults: defaults, startListening: false, observeDefaults: false)
        monitor.reloadConfig()

        let event = makeEvent(keyCode: CGKeyCode(0x92), flags: [], keyDown: true)
        XCTAssertTrue(monitor.handleForTesting(event, type: .keyDown))
    }
    ...
    func testNewlineSymbolAliasMatchesReturnKeyCode() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
    ...
    func testReturnSymbolAliasPedestalMatchesReturnKeyCode() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
    ...
    func testNumReturnAliasMatchesKeypadEnterKeyCode() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenShift)
        defaults.set("num return", forKey: AppDefaults.Keys.hotkeyKey)
        defaults.set(HotkeyMode.toggle.rawValue, forKey: AppDefaults.Keys.hotkeyMode)
    ...
    func testNumEnterKeyAliasMatchesKeypadEnterKeyCode() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenShift)
        defaults.set("num enter key", forKey: AppDefaults.Keys.hotkeyKey)
        defaults.set(HotkeyMode.toggle.rawValue, forKey: AppDefaults.Keys.hotkeyMode)
    ...
    func testKpReturnAliasMatchesKeypadEnterKeyCode() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenShift)
        defaults.set("kp return", forKey: AppDefaults.Keys.hotkeyKey)
        defaults.set(HotkeyMode.toggle.rawValue, forKey: AppDefaults.Keys.hotkeyMode)
    ...
    func testArrowLeftAliasMatchesLeftArrowKeyCode() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenShift)
        defaults.set("arrowleft", forKey: AppDefaults.Keys.hotkeyKey)
        defaults.set(HotkeyMode.toggle.rawValue, forKey: AppDefaults.Keys.hotkeyMode)
    ...
    func testNumLockAliasMatchesKeypadClearKeyCode() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenShift)
        defaults.set("num lock", forKey: AppDefaults.Keys.hotkeyKey)
        defaults.set(HotkeyMode.toggle.rawValue, forKey: AppDefaults.Keys.hotkeyMode)

        let monitor = HotkeyMonitor(defaults: defaults, startListening: false, observeDefaults: false)
        monitor.reloadConfig()

        let event = makeEvent(keyCode: CGKeyCode(kVK_ANSI_KeypadClear), flags: [], keyDown: true)
        XCTAssertTrue(monitor.handleForTesting(event, type: .keyDown))
    }

    func testNumLockCompactAliasMatchesKeypadClearKeyCode() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
    ...
    func testClearSymbolAliasMatchesKeypadClearKeyCode() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
    ...
    func testShortcutPasteWithTrailingPlusUsesPlusKey() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
        ...
        let event = makeEvent(keyCode: CGKeyCode(kVK_ANSI_Equal), flags: [], keyDown: true)
        XCTAssertTrue(monitor.handleForTesting(event, type: .keyDown))
    }

    func testCompactShortcutPasteWithTrailingPlusUsesPlusKey() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
    ...
    func testOutOfRangeFunctionKeyShowsGuidanceMessage() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(true, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenShift)
        defaults.set("f25", forKey: AppDefaults.Keys.hotkeyKey)
        defaults.set(HotkeyMode.toggle.rawValue, forKey: AppDefaults.Keys.hotkeyMode)
    ...
    func testFunctionKeyWordAliasMatchesConfiguredFKey() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenShift)
        defaults.set("function key 12", forKey: AppDefaults.Keys.hotkeyKey)
        defaults.set(HotkeyMode.toggle.rawValue, forKey: AppDefaults.Keys.hotkeyMode)

        let monitor = HotkeyMonitor(defaults: defaults, startListening: false, observeDefaults: false)
        monitor.reloadConfig()

        let event = makeEvent(keyCode: CGKeyCode(kVK_F12), flags: [], keyDown: true)
        XCTAssertTrue(monitor.handleForTesting(event, type: .keyDown))
    }

    func testFnKeyWordAliasMatchesConfiguredFKey() {
        let defaults = makeDefaults()
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyRequiredShift)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenCommand)
        defaults.set(false, forKey: AppDefaults.Keys.hotkeyForbiddenShift)
        defaults.set("fn key 3", forKey: AppDefaults.Keys.hotkeyKey)
        defaults.set(HotkeyMode.toggle.rawValue, forKey: AppDefaults.Keys.hotkeyMode)

        let monitor = HotkeyMonitor(defaults: defaults, startListening: false, observeDefaults: false)
        monitor.reloadConfig()

        let event = makeEvent(keyCode: CGKeyCode(kVK_F3), flags: [], keyDown: true)
        XCTAssertTrue(monitor.handleForTesting(event, type: .keyDown))
    }
    ...
    func testUnsafeTypingTriggerWithoutModifiersShowsGuidance() {
        ...
        XCTAssertEqual(
            monitor.statusMessage,
            "Hotkey disabled: trigger key A without required modifiers is too easy to trigger while typing. Add at least one required modifier. Configured hotkey: Toggle • A."
        )
    }
